    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/20 transition-colors duration-300">
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          {searchTerm && (
            <button 
              ...
              className="text-sm font-bold text-destructive hover:text-destructive/80 hover:underline flex items-center gap-1"
            >
      ...
      <footer className="border-t border-border mt-12 py-10 bg-background text-center transition-colors duration-300">
        <p className="text-sm text-muted-foreground">
          © 2024 Tra cứu Bác sĩ Đà Nẵng. Dữ liệu được quản lý bởi Admin.
        </p>
      </footer>
